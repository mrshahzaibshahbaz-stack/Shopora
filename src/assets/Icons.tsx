...
export const HelloFaloIcon = (props: SvgProps) => (
  <Svg
    width={18}
    height={17}
    viewBox="0 0 18 17"
  ...
  >
    <Path
      d="M14.8452 0.146238C14.7993 0.0997446 14.7445 0.0628674 14.6842 0.0377594C14.6239 0.0126514 14.5591 -0.000184192 14.4938 1.99692e-06C14.4284 0.000188186 14.3638 0.0133925 14.3036 0.0388438C14.2434 0.0642952 14.1889 0.101484 14.1432 0.148238C14.0509 0.244278 14.0001 0.372707 14.0016 0.505874C14.0031 0.639041 14.0568 0.766295 14.1512 0.860238C14.8705 1.58086 15.4125 2.45878 15.7344 3.42471C16.0563 4.39065 16.1494 5.41818 16.0062 6.42624C15.9871 6.55785 16.0205 6.69168 16.099 6.799C16.1775 6.90632 16.295 6.97857 16.4262 7.00024C16.4909 7.01042 16.557 7.00757 16.6206 6.99187C16.6842 6.97617 16.744 6.94794 16.7965 6.90882C16.849 6.8697 16.8932 6.82049 16.9265 6.76406C16.9597 6.70764 16.9814 6.64514 16.9902 6.58024C17.1557 5.41492 17.0481 4.22708 16.6759 3.11048C16.3036 1.99388 15.6769 0.979096 14.8452 0.146238ZM3.62319 2.03624C3.63781 1.67933 3.77145 1.33758 4.00281 1.06542C4.23417 0.793258 4.54995 0.606348 4.89985 0.534459C5.24975 0.462569 5.61364 0.509836 5.93357 0.668729C6.25349 0.827623 6.51104 1.089 6.66519 1.41124C6.86368 1.23385 7.10329 1.1088 7.36231 1.04739C7.62133 0.985992 7.89158 0.990186 8.14857 1.0596C8.40556 1.12901 8.64117 1.26144 8.83405 1.4449C9.02694 1.62836 9.171 1.85705 9.25319 2.11024L9.34119 2.37924C9.54202 2.21183 9.78081 2.09618 10.0367 2.04242C10.2925 1.98866 10.5577 1.99842 10.8089 2.07084C11.0601 2.14327 11.2898 2.27615 11.4778 2.45787C11.6657 2.63959 11.8063 2.86461 11.8872 3.11324L12.9532 6.34424L13.5372 8.04824C13.9659 9.3009 14.096 10.6364 13.9172 11.9482L13.6472 13.9362C13.5885 14.368 13.4181 14.7769 13.1527 15.1224C12.8873 15.468 12.5362 15.7382 12.1342 15.9062L9.97619 16.8072C9.00519 17.2132 7.90819 16.9552 7.17219 16.2502C4.06219 13.2682 1.29319 12.2802 0.532194 12.0502C0.174194 11.9432 -0.131806 11.5312 0.058194 11.0782C0.208194 10.7232 0.568194 10.0992 1.34019 9.75824C1.93219 9.49524 2.70019 9.42824 3.68919 9.69024L1.76319 4.10524C1.632 3.70009 1.66634 3.2595 1.85874 2.87958C2.05113 2.49966 2.38597 2.21124 2.79019 2.07724C3.07019 1.98524 3.35619 1.97624 3.62319 2.03624ZM5.77419 5.68324L6.32919 7.36124C6.35088 7.4238 6.35993 7.49005 6.3558 7.55614C6.35168 7.62222 6.33447 7.68683 6.30517 7.74622C6.27587 7.8056 6.23507 7.85857 6.18514 7.90206C6.13521 7.94554 6.07713 7.97868 6.01429 7.99954C5.95144 8.0204 5.88508 8
319 2.29124L5.75519 5.62124L5.77819 5.68124H5.77519L5.77419 5.68324ZM13.2412 2.07524C13.2975 2.04148 13.36 2.01914 13.4249 2.00952C13.4899 1.99989 13.5561 2.00315 13.6198 2.01913C13.6835 2.0351 13.7435 2.06347 13.7962 2.10261C13.8489 2.14175 13.8935 2.19089 13.9272 2.24724L14.2232 2.74224C14.7218 3.5761 14.9893 4.52772 14.9982 5.49924C14.9995 5.63185 14.9481 5.75955 14.8553 5.85426C14.7625 5.94896 14.6358 6.00291 14.5032 6.00424C14.3706 6.00556 14.2429 5.95416 14.1482 5.86133C14.0535 5.7685 13.9995 5.64185 13.9982 5.50924C13.9911 4.71502 13.7727 3.93701 13.3652 3.25524L13.0692 2.76124C13.0354 2.7049 13.0131 2.64247 13.0035 2.5775C12.9938 2.51254 12.9971 2.44631 13.0131 2.38261C13.0291 2.3189 13.0574 2.25897 13.0966 2.20623C13.1357 2.15349 13.1848 2.10898 13.2412 2.07524Z"
      fill="#F17547"
    />
  </Svg>
);
...
export const WatchIcon = (props: SvgProps) => {
  const { fill = 'black', fillOpacity = 0.4, ...rest } = props;
  return (
    <Svg
      width={21}
      height={25}
...
export const ClothIcon = (props: SvgProps) => {
  const { fill = 'black', fillOpacity = 0.4, ...rest } = props;
  return (
...
export const BagIcon = (props: SvgProps) => {
  const { fill = 'black', fillOpacity = 0.4, ...rest } = props;
  return (
    <Svg width={22} height={25} viewBox="0 0 22 25" fill="none" {...rest}>
      <Path
...
export const ShoeIcon = (props: SvgProps) => {
  const { fill = 'black', fillOpacity = 0.4, ...rest } = props;
  return (
    <Svg width={25} height={21} viewBox="0 0 25 21" fill="none" {...rest}>
      <Path
...
export const GlassesIcon = (props: SvgProps) => {
  const { fill = 'black', fillOpacity = 0.4, ...rest } = props;
  return (
    <Svg width={26} height={22} viewBox="0 0 26 22" fill="none" {...rest}>
      <Path
...
export const HreatIcon = (props: SvgProps) => (
  <Svg
    width={22}
    height={22}
    viewBox="0 0 22 22"
  ...
  >
    ...
    />
    <Path
      d="M15.8652 7.12969C15.5977 6.86203 15.28 6.6497 14.9304 6.50483C14.5808 6.35996 14.206 6.2854 13.8276 6.2854C13.4492 6.2854 13.0744 6.35996 12.7248 6.50483C12.3752 6.6497 12.0575 6.86203 11.79 7.12969L11.2347 7.68493L10.6795 7.12969C10.1391 6.58928 9.40614 6.28568 8.64188 6.28568C7.87763 6.28568 7.14467 6.58928 6.60426 7.12969C6.06385 7.6701 5.76025 8.40305 5.76025 9.16731C5.76025 9.93156 6.06385 10.6645 6.60426 11.2049L7.1595 11.7602L11.2347 15.8354L15.31 11.7602L15.8652 11.2049C16.1329 10.9374 16.3452 10.6197 16.4901 10.2701C16.6349 9.92049 16.7095 9.54575 16.7095 9.16731C16.7095 8.78886 16.6349 8.41413 16.4901 8.0645C16.3452 7.71488 16.1329 7.39723 15.8652 7.12969Z"
      fill="#CFCFCF"
    />
  </Svg>
);